interface IconMoretype {
    className?: string
}

export const IconMore = ({ className }: IconMoretype) => {
    return (
        <svg className={className} width='20' height='4' viewBox='0 0 20 4' xmlns='http://www.w3.org/2000/svg'>
